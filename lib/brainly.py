...
def brainly(url):
    bs=BeautifulSoup(requests.get("https://brainly.com?search="+url, headers={'User-Agent': 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:52.0) Gecko/20100101 Firefox/52.0'}).text, html.parser)
